...
const Profile = () => {
  ...
  +
        <div className='rounded-[30px] fixed  w-[350px] h-[670px] left-[30.93px] top-[29px] bg-[#183740] shadow-2xl'>
          ...
          <Link to='/home'><img className='absolute w-[30px] h-[25px] left-[75px] top-[190px]' src={home}></img><p className='text-md  absolute left-[140px] top-[190px] text-white '>Home</p></Link>
         <Link to="/profile"><img className='absolute w-[25px] h-[25px] left-[75px] top-[250px]' src={profile}></img><p className='text-md font-bold text-white absolute left-[140px] top-[250px] '>My Profile</p></Link>
        ...
        <div className='bg-[#132C33] fixed w-[25px] h-[25px] left-[1182px] top-[20px] flex justify-between flex-row' >
          <img className='w-[25px] m-[20px] h-[25px]' src={chat}></img>
          <img className='w-[25px] mt-[20px] ml-[5px] h-[25px]' src={notifications}></img>
          <button className='text-[#69DCEB] mt-[20px] ml-[15px]' onClick={handleLogout}>Logout</button>
        </div>
        ...
        <img className='fixed w-[305px] h-[350px] top-[92px] left-[1170px] ' src={skills}></img>
        <img className='fixed w-[305px] h-[300px] top-[430px] left-[1170px] ' src={applied}></img>
        ...
        <div className='rounded-[30px] absolute w-[670px] h-[595px] left-[450px] top-[860px] bg-[#183740] shadow-2xl'>
          ...
          <img className='absolute w-[500px] h-[300px] top-[200px] left-[100px]' src={post}></img>
        </div>
