...
<p className='text-[#69DCEB] absolute w-[1000px] h-[55px] left-[345px] top-[200px] font-[700] text-[35px] leading-[96px]'>COMPANY LOGIN</p>
...
<input className='rounded-[10px] absolute w-[400px] h-[35px] left-[289px] top-[340px] bg-[#EFFFFA]'
    ...
    <p className='text-[#EFFFFA] text-sm absolute left-[289px] top-[500px]' >Don't have an account? <Link to='/cregister'> <button className='text-[#69DCEB] font-medium'
