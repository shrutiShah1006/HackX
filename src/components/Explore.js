...
const Explore = () => {
  return (
      ...
      <div className='rounded-[30px] fixed  w-[350px] h-[670px] left-[30.93px] top-[29px] bg-[#183740] shadow-2xl'>
        ...
        <img className='absolute w-[25px] h-[25px] left-[75px] top-[310px]' src={explore}></img><p className='text-md text-white absolute left-[140px] top-[310px] font-bold'>Explore</p>
